      ...
      >
        ...
        >
          <Heading
            ...
            color={'white'}
          >
            AI Innovation <span style={{ color: 'var(--accent-orange)' }}>:</span>
          ...
          >
            ...
            is an AI-themed event through which you can easily explore a wide range of workshops,
            sessions, competitions, E-sports games, and a thrilling musical night near the end.
            <br />
            <span
              style={{

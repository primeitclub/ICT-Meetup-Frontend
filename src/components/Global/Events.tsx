...
import { Button, Flex, Heading, Image, Box, VStack, Text, HStack } from '@chakra-ui/react';
import { LuBox } from 'react-icons/lu';
import SectionHeader from '../reusables/SectionHeader';

const data = ['Data Science', 'Web 3', 'NEural Networks', 'Git and Github', 'Computer Vision'];
  ...
  <>
   <Box paddingY={'100px'} position={'relative'}>
    ...
    >
     ...
     <Flex align={'center'}>
      <Flex direction={'column'} gap={'48px'} align={'center'} width={'full'}>
       <Heading
        as="h1"
        fontSize={'3xl'}
        fontFamily="heading"

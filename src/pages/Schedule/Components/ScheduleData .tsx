...
import { DataSchedule, ProgramType } from "./DataScheme/DataScheme";
              ...
              >
                ...
                >
                  <Stack gap={0}>
                    <Heading
                      fontWeight={600}
                      fontSize={{ lg: "28px", sm: "20px", base: "20px" }}
                      as={"h4"}
                    >
                      {item.EventName}
                    </Heading>
                  ...
                  <Box>
                    {item.EventType === "Event" ? (
                      <Text
                        ...
                        bg={
                          ProgramType[
                            item.ProgramType as keyof typeof ProgramType
                          ]
                        }
                        p={"5px 12px"}
                      >
